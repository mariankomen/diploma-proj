...
import ResistorInfoPage from "../resistor-info-page/resistor-info-page";
...
<div>
    {/*<Route path='/catalog/resistors/:id'  render={() => <ResistorInfoPage/>} />*/}
    <div className={style.main}>
            <Card style={{ width: '16rem', height: "420px"}}>
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                       <span className={style.price}><p>Ціна:  </p> <span><h5>{props.price} грн</h5></span></span>
                    </Card.Text>
                    <NavLink to={`/catalog/resistors/${props.id}`}><Button variant="danger"
                                     className={style.btn}
                                     onClick={() => {
                                         setVisible(!visible)
                                         props.setResID(props.id)
                                     }}
